...
# ----------------- CONFIGURE THESE -----------------
NVR_IP = "192.168.110.11"
NVR_PORT = 554     # 554 is default; use your RTSP port
NVR_USER = "admin"
NVR_PASS = "aa123456"
...
EARLY_STOP_CONSECUTIVE_FAILS = 5  # stop discovery after N consecutive no-signal channels (if we found at least one working)
